...
- `valorInicial` (opcional): Valor inicial do acumulador. Se não fornecido, o primeiro elemento do array é usado como valor inicial e a iteração começa a partir do segundo elemento.
